...
Question: Design a week-by-week schedule for all 16 weeks. Should the student submit the conference paper? Justify all choices.`,
  ...
  // ── SET D — SESSION 4 CONTROL (NO AI AVAILABLE) ─────────────────────────
  // Same structure and difficulty progression as A/B/C, but used only in the
  // no-AI control session. New content avoids practice effects from A/B/C.
  D: [
    {
      id: "D1",
      diff: "easy",
...
Question: Who owns the dog, and what floor do they live on? Show your reasoning step by step.`,
      scoring_guide: "Full (2): correctly identifies the dog owner and their floor with clear step-by-step reasoning. Partial (1): correct conclusion without full reasoning, or partial reasoning with an error. Zero (0): incorrect or blank.",
      ans_hint: "Write your reasoning step by step, then give your final answer.",
      hint1: "no AI available in this session",
      hint2: "no AI available in this session",
      full: "no AI available in this session"
...
The microscope is available for 10 hours total this week, split however you choose across the three students.

Question: How do you allocate the 10 hours among the three students? Justify your reasoning.`,
      scoring_guide: "Full (2): proposes a clear allocation that fits within 10 hours, addresses urgency (X's deadline, Z's visitor constraint) and fairness (Y's wait time) explicitly. Partial (1): allocation given but justification addresses only one or two factors. Zero (0): no clear allocation or exceeds available hours.",
...
// Session 4 always uses Set D (no-AI control session) for every participant.
function getTaskSet(pid, sessionNum) {
  if (sessionNum === 4) return TASK_SETS["D"];
